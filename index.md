...
![Boston 311](./images/Boston-311.png)
...
//import {neighborhoods, reasonsByNeighborhood} from "./data.md";


const zip = view(Inputs.select([
  "02126",
  "02121" ,
  "02108" ,
  "02127",
  ...
  "02133" ,
  "02446" 
], {label: "Please select a zip code", multiple: false}))
```

${zip}

## Reason Count for ${zip}


## Insights for ${zip}

```js
databoston = await FileAttachment("boston_311_data.csv").csv();
databoston.slice(0, 5); // Display first 5 rows